...
public class OrderHistory {
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.equals(pricePayedPerUnit, that.pricePayedPerUnit) && Arrays.equals(quantityOrdered, that.quantityOrdered) && Objects.equals(weightUnitForPrice, that.weightUnitForPrice) && Arrays.equals(dateOfPurchase, that.dateOfPurchase) && Arrays.equals(itemCode, that.itemCode) && Arrays.equals(transactionId, that.transactionId);
    }
