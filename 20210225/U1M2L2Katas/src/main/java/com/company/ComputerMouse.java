...
public class ComputerMouse {
    ...
    public ComputerMouse(String manufacturer, String model, int xPosition, int yPosition,
    ...
    public void move(int deltaX, int deltaY){
        System.out.println("The mouse has moved " + deltaX + " on the x-axis, and " +
                deltaY + " on the y-axis.");
    }
